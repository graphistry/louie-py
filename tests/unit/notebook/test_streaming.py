        ...
        with patch('louieai.notebook.streaming.HAS_IPYTHON', True):
            with patch('louieai.notebook.streaming.clear_output') as mock_clear:
                with patch('time.time') as mock_time:
                    ...
                    display.update({"payload": {"id": "B_001", "type": "TextElement", "text": "Hi"}})
                    ...
                    display.update({"payload": {"id": "B_002", "type": "TextElement", "text": "Hello"}})
...
class TestStreamResponse:
    ...
    def test_streaming_with_dataframe(self, mock_client):
        ...
        mock_client._fetch_dataframe_arrow.assert_called_once_with("D_test123", "df_456")
