...
class TestStreamingResponse:
    ...
    def test_client_reads_all_elements(self):
        ...
        mock_lines = [
            ...
            '{"payload": {"id": "1", "type": "TextElement", "content": "Creating dataframe..."}}',
            '{"payload": {"id": "2", "type": "DfElement", "table": {"data": [1, 2, 3]}}}',
        ]
    ...
    def test_client_handles_delayed_dataframe(self):
        ...
        mock_lines = [
            ...
            '{"payload": {"id": "1", "type": "TextElement", "content": "Let me create a dataframe..."}}',
            '{"payload": {"id": "1", "type": "TextElement", "content": "Let me create a dataframe...\\nGenerating data..."}}',
            '{"payload": {"id": "1", "type": "TextElement", "content": "Let me create a dataframe...\\nGenerating data...\\nHere it is:"}}',
            '{"payload": {"id": "2", "type": "DfElement", "table": {"cols": ["A", "B"], "data": [[1, 2], [3, 4]]}}}',
        ]
