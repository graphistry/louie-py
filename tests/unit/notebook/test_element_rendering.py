...
class TestElementRendering:
    ...
    def test_debug_line_rendering(self):
        ...
        response = Response(
            thread_id="D_test",
            elements=[
                {"type": "DebugLine", "text": "Debug: Variable x = 42"}
            ]
        )
    ...
    def test_info_line_rendering(self):
        ...
        response = Response(
            thread_id="D_test",
            elements=[
                {"type": "InfoLine", "text": "Info: Processing started"}
            ]
        )
    ...
    def test_warning_line_rendering(self):
        ...
        response = Response(
            thread_id="D_test",
            elements=[
                {"type": "WarningLine", "text": "Warning: Deprecated function"}
            ]
        )
    ...
    def test_error_line_rendering(self):
        ...
        response = Response(
            thread_id="D_test",
            elements=[
                {"type": "ErrorLine", "text": "Error: File not found"}
            ]
        )
    ...
    def test_unknown_element_with_text(self):
        ...
        response = Response(
            thread_id="D_test",
            elements=[
                {"type": "CustomElement", "text": "Custom content"}
            ]
        )
