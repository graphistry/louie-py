...
class TestMockResponseLibrary:
    ...
    def test_graph_response(self):
        ...
        response = MockResponseLibrary.graph_response(
            num_nodes=100,
            num_edges=200
        )
...
class TestMockStreamingResponse:
    ...
    def test_text_streaming(self):
        ...
        elements = [
            MockResponseLibrary.text_response("Hello world from Louie")
        ]
...
class TestMockAPIResponse:
    ...
    def test_visualization_query_detection(self):
        ...
        response = create_mock_api_response("Create a network graph of user connections")
