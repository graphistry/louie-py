...
from unit.test_documentation import extract_python_blocks, preprocess_code
...
class TestDocumentationIntegration:
    ...
    def test_thread_persistence(self, real_client):
        ...
        thread = real_client.create_thread(
            ...
            initial_prompt="Remember the number 42"
        )
    ...
    def test_concurrent_threads(self, real_client):
        ...
        for i in range(3):
            thread = real_client.create_thread(
                ...
                initial_prompt=f"This is thread number {i}"
            )
